...
: ${AMENT_CURRENT_PREFIX:="/humble/install/rclc_examples"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rclc_examples/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rclc_examples/environment/path.sh"
