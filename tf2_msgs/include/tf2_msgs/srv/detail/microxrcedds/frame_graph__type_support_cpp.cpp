...
#include "tf2_msgs/srv/detail/frame_graph__rosidl_typesupport_microxrcedds_cpp.hpp"
...
static size_t _FrameGraph_Request__get_serialized_size_with_initial_alignment(
...
static message_type_support_callbacks_t _FrameGraph_Request__callbacks = {
  ...
  _FrameGraph_Request__get_serialized_size_with_initial_alignment,
...
{
  return &tf2_msgs::srv::typesupport_microxrcedds_cpp::_FrameGraph_Request__handle;
}
  ...
  ucdrBuffer * cdr)
{
  ...
  // Member: frame_yaml
  rv = ucdr_serialize_string(cdr, ros_message.frame_yaml.c_str());
  ...
  tf2_msgs::srv::FrameGraph_Response & ros_message)
{
  ...
  // Member: frame_yaml
  ros_message.frame_yaml.resize(ros_message.frame_yaml.capacity());
  rv = ucdr_deserialize_string(cdr, &ros_message.frame_yaml[0], ros_message.frame_yaml.capacity());
  if (rv) {
    ros_message.frame_yaml.resize(std::strlen(&ros_message.frame_yaml[0]));
  }
...
static size_t _FrameGraph_Response__get_serialized_size_with_initial_alignment(
  const void * untyped_ros_message, size_t current_alignment)
{
  auto typed_message =
    static_cast<const tf2_msgs::srv::FrameGraph_Response *>(
...
static message_type_support_callbacks_t _FrameGraph_Response__callbacks = {
  ...
  _FrameGraph_Response__get_serialized_size_with_initial_alignment,
...
{
  return &tf2_msgs::srv::typesupport_microxrcedds_cpp::_FrameGraph_Response__handle;
}
...
{
  return &tf2_msgs::srv::typesupport_microxrcedds_cpp::_FrameGraph__handle;
}
